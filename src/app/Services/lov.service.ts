...
export class LovService {
  ...
  /**
   * Performance Optimization: Caching for semi-static data.
   * categoriesCache$ stores the list of categories.
   * lovCache stores LOV items keyed by category ID (lovTypeId).
   */
   ...
   * Should be called when data is modified (add/delete) or on logout.
   */
  private clearCache() {
